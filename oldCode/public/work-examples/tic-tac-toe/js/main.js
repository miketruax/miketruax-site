/*All these original declarations of the HTML are being done since it was originally being run
 ...
 getText('win.txt', $win);
 it was also done this way for easy portability to home machines
